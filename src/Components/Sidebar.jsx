  ...
  return (
    <>
      ...
      `}>
        ...
        <div className={`relative rounded-xl border overflow-hidden backdrop-blur-md transition-colors ${
          isLight ? 'bg-white border-slate-200 shadow-xs' : 'bg-slate-900/60 border-white/10 shadow-sm'
        }`}>
          
          {/* Top Banner Cover Image Space with bg.png */}
          <div className={`relative h-14 lg:h-16 w-full overflow-hidden border-b ${
            ...
            <div className="absolute top-1.5 right-1.5 flex items-center gap-1 z-10">
              <div className="font-mono text-[8px] text-emerald-300 bg-black/60 px-1.5 py-0.5 rounded-full border border-emerald-500/30 backdrop-blur-xs hidden sm:block">
                MERN & AI
              </div>
              ...
              <button
                onClick={() => setMobileOpen(false)}
                className="lg:hidden p-1 rounded-full bg-slate-950/80 hover:bg-slate-900 border border-white/20 text-slate-300 hover:text-white transition shadow-md"
          ...
          <div className="p-2.5 pt-0">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="relative -mt-7 lg:-mt-8 mb-1 group">
                <div className={`relative w-14 h-14 lg:w-16 lg:h-16 rounded-full overflow-hidden p-0.5 ${
                ...
                {/* Live Status Badge */}
                <div className={`absolute -bottom-0.5 -right-0.5 border rounded-full px-1 py-0.5 flex items-center gap-1 ${
                  ...
                  <span className="text-[8px] font-mono text-emerald-600 dark:text-emerald-400 font-medium">Available</span>
                </div>
              </div>
              ...
              <p className="text-[10px] text-emerald-600 dark:text-emerald-400 font-mono mt-0.5 flex items-center gap-1 font-medium">
                <Code2 className="w-3 h-3" />
                MERN Stack & CS Undergrad
              </p>

              {/* Sub details */}
              <div className={`mt-1.5 w-full pt-1 border-t flex flex-col gap-0.5 text-[10px] text-left font-mono ${
            ...
            <div className={`mt-1.5 pt-1.5 border-t flex flex-col gap-1.5 ${
              ...
              <a
                ...
                download
                className="w-full py-1.5 px-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-[11px] font-mono font-semibold rounded-lg flex items-center justify-center gap-1.5 shadow-xs shadow-emerald-900/20 transition transform active:scale-95 border border-emerald-400/30 shrink-0"
              >
              ...
              <div className={`flex items-center justify-around p-0.5 rounded-lg border ${
        ...
        <div className="flex flex-col gap-1 mt-0.5">
          <div className={`px-2 flex items-center justify-between text-[10px] font-mono ${
            isLight ? 'text-slate-500' : 'text-slate-400'
          }`}>
            <span>NAVIGATION</span>
            <span className="text-[9px] font-mono">5 sections</span>
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`
                    w-full px-2.5 py-1.5 rounded-lg text-xs font-mono flex items-center justify-between transition-all duration-200 group border
                    ${isActive 
        ...
        <div className={`mt-auto pt-1.5 border-t text-center shrink-0 ${
          isLight ? 'border-slate-200' : 'border-white/10'
        }`}>
